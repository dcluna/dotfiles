...
(setq straight-packages '(
                          ...
                          (forge :type git :host github :repo "magit/forge" :commit "d4eb8d1be55398e350c8a68b0c355f5166418843")
                          minitest
                          helpful
                          ...
                          ;; lsp-mode
                          jq-mode
                          (rubocop :type git :host github :repo "bbatsov/rubocop-emacs"
                                   :my-fork (:host github :repo "dcluna/rubocop-emacs"))
                          ;; org
