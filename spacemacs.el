...
(defvar dcl/light-themes
  (dcl/shuffle
   '(greymatters nano-light mindre grey-paper flexoki-themes-light cloud chyla brutalist berrys hima aircon acme twilight-bright hemisu-light apropospriate-light flatui
...
(defvar dcl/dark-themes
  (dcl/shuffle
   '(nano-dark flexoki-themes-dark chyla-dark arjen-grey helix kaolin-dark kaolin-aurora kaolin-bubblegum kaolin-eclipse
