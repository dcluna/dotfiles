...
** Ruby
   #+BEGIN_SRC emacs-lisp
     ...
     (defvar rubocop-files-history (list '(split-string (shell-command-to-string "\"git diff --name-only HEAD master\"") "\"\\n\"") ))
...
** Yasnippets
    #+BEGIN_SRC emacs-lisp
      ...
      (add-to-list 'yas-snippet-dirs "/home/dancluna/yasnippets")
    #+END_SRC
    ...
    ((org-mode . ((eval . (progn
                            ...
                            (defun gen-nmap-script-cmd (scriptpart)
                              ...
                              (let ((scriptsearch (format "ls $NMAPSCRIPTSDIR/*%s*" scriptpart)))
                                (kill-new (message "nmap --script=$(%s | paste -s -d\",\") -oA" scriptsearch))))
