...
** Vagrant
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (defun dcl/vagrant-shell--term (cmd)
       ...
       (let ((buf (ansi-term "/bin/sh" "vagrant-term")))
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (with-eval-after-load 'transient
       (transient-define-prefix dcl/vagrant-shell-transient ()
         ...
         ["Optional"
          :if (lambda () (featurep 'vterm))
          ("v" "vterm" dcl/vagrant-shell-vterm)]
         ["  "
          :if (lambda () (featurep 'multishell))
          ("m" "multishell" dcl/vagrant-shell-multishell)]))
   #+END_SRC
