...
* Straight.el (package manager)
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (setq straight-packages '((helm-c-yasnippet :type git :host github :repo "dcluna/helm-c-yasnippet"
...
** ERC
   #+BEGIN_SRC emacs-lisp
     ...
     (setq erc-autojoin-channels-alist '(("freenode.net" "#emacs" "#offsec")))
...
**** Rubocop
     ...
     #+BEGIN_SRC emacs-lisp
       ...
       (defun dcl-setup-rubocop-autosave ()
         (add-hook 'before-save-hook 'dcl-rubocop-silent nil t))

       (add-hook 'ruby-mode-hook 'dcl-setup-rubocop-autosave)
       (add-hook 'enh-ruby-mode-hook 'dcl-setup-rubocop-autosave)

       (defun dcl-toggle-rubocop-autosave ()
         (interactive)
         (let ((rubocop-mode-p (memq major-mode '(enh-ruby-mode ruby-mode))))
           (when rubocop-mode-p
             (if (memq 'dcl-rubocop-silent before-save-hook)
                 (progn
                   (remove-hook 'before-save-hook 'dcl-rubocop-silent t)
                   (message "Auto-Rubocop is off"))
               (progn
                 (dcl-setup-rubocop-autosave)
                 (message "Auto-Rubocop is on"))))))
