...
* Straight.el (package manager)
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (setq straight-packages '(
                              ...
                              evil-numbers
                              (magit-todos :type git :host github :repo "alphapapa/magit-todos" :branch "async-ag"
                                           :upstream (:host github :repo "alphapapa/magit-todos"))
                              auto-minor-mode
...
*** Pretty-mode / prettify-symbols-mode
    ...
    #+BEGIN_SRC emacs-lisp
      (add-hook 'enh-ruby-mode-hook 'turn-on-pretty-mode)
      (add-hook 'enh-ruby-mode-hook 'dcl/enh-ruby-prettify-symbols)

      (defun dcl/enh-ruby-prettify-symbols ()
        (pretty-deactivate-groups '(:neg :lambda) 'ruby-mode)  ;bang-style methods aren't very visible with this
...
**** Rubocop
     ...
     #+BEGIN_SRC emacs-lisp
       (defun dcl-rubocop-silent ()
         (when (memq major-mode '(enh-ruby-mode ruby-mode))
           (save-window-excursion (rubocop-autocorrect-current-file))))

       (defun dcl-setup-rubocop-autosave (&optional remove local)
         (if remove
             (remove-hook 'before-save-hook 'dcl-rubocop-silent local)
           (add-hook 'before-save-hook 'dcl-rubocop-silent nil local)))

       (define-minor-mode auto-rubocop-mode
         "Toggle Rubocop's autocorrect.
       ...
       and toggles it if ARG is `toggle'."
         ...
         (cond
          (auto-rubocop-mode
           (dcl-setup-rubocop-autosave nil t))
          (t
           (dcl-setup-rubocop-autosave t t))))
     #+END_SRC
...
** Yasnippets
   ...
   #+BEGIN_SRC emacs-lisp
      (defvar dcl-yas-snippets-dir (expand-file-name "yasnippets" "/mnt/lmde/home/dancluna") "Personal yasnippets directory")
...
** Auto-minor-mode
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (add-to-list 'auto-minor-mode-alist '("\.rb$" . auto-rubocop-mode))
   #+END_SRC
...
* OSCP
  ...
  #+BEGIN_SRC emacs-lisp :tangle /home/dancluna/code-of-mine/oscp/.dir-locals.el
    ((org-mode . ((eval . (progn
                            (setq-local org-src-window-setup 'other-window)
                            (setq-local yas-snippet-dirs (append '("/home/dancluna/code-of-mine/oscp/yasnippets") yas-snippet-dirs))
...
* Geno.me
  :PROPERTIES:
  :header-args: :noweb yes :noweb-ref genome
  :END:

  #+BEGIN_SRC emacs-lisp
    (org-babel-load-file "/home/dancluna/dotfiles/genome.org")
  #+END_SRC
